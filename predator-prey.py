...
def reset_predators(predators):
    ...
    for predator in predators:
        predator.rect.x = 0  # Define starting x-coordinate
        predator.rect.y = 0  # Define starting y-coordinate
...
class Animal:
    def __init__(self, x, y, color):
        ...
        self.color = color
        self.brain = np.random.rand(3, 2)  # Adjusted brain shape
...
while running:
    ...
    for cat in cats:
        ...
        if closest_mouse:
            ...
            inputs = np.array([diff_x, diff_y, 1])  # Cat inputs
        else:
    ...
    for mouse in mice:
        ...
        if closest_cat:
            ...
            inputs = np.array([diff_x, diff_y, 1])  # Mouse inputs
        else:
