...
class Animal:
  ...
  # Example brain structure
    ...
    def move(self, direction):
        ...
        random_scale = 0.2  # Adjust this to increase/decrease randomness
...
cats = [Cat(random.randint(0, SCREEN_WIDTH), random.randint(0, SCREEN_HEIGHT)) for _ in range(2)]
...
while running:
    ...
    for cat in cats:
        for mouse in mice:
            if check_collision(cat, mouse, CATCH_DISTANCE) and cat.catch == False:
                mutate_brain(mouse.brain, .3)
